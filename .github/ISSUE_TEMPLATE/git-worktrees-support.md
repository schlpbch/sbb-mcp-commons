---
name: Git Worktrees Support
about: Add support for git worktrees in cross-repository development workflow
title: 'Post-MVP: Support git worktrees for parallel development'
