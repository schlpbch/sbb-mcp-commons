...
/**
 * Abstract base class for MCP tools providing structured validation and error handling.
 *
 * <p>This template implements a standardized tool invocation pattern combining:</p>
 * <ul>
 *   <li><b>Structured validation</b>: Parse and validate input parameters before execution</li>
 *   <li><b>Type safety</b>: Strongly-typed input (I) and output (O) parameters</li>
 *   <li><b>Standard error handling</b>: Consistent error conversion to McpResult</li>
 *   <li><b>State modification flag</b>: Override isStateModifying() for write operations</li>
 * </ul>
 *
 ...
 * <ul>
 *   <li>{@link IllegalArgumentException} → {@link McpError.ErrorCode#INVALID_INPUT}</li>
...
public abstract class BaseMcpTool<I, O> implements McpTool<McpResult<O>> {
     ...
     * @throws IllegalArgumentException if validation fails (converted to INVALID_INPUT error)
     */
     ...
     *
     * <p>This method contains the business logic and should:</p>
     * <ul>
     ...
     *
     * <p>This final method coordinates validation, execution, and error handling:</p>
     * <ol>
     ...
     *
     * <p>Override this method to return {@code true} for state-modifying operations
     * (create, update, delete, booking, payment, etc.).</p>
     *
     ...
     *
     * <p>Override to provide a meaningful category (e.g., "search", "booking", "information").</p>
     *
